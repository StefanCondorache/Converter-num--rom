...
print('Dacă dorești să transformi doar un număr, scrie 0. Dacă dorești să le vezi pe toate, scrie 1.')
y = int(input('::'))
if y == 0:
    print(intstr(float(input('Numărul pe care dorești să-l transformi: '))))
elif y == 1:
    print('Va trebui să aștepți un pic...')
    with open('desktop/output.txt', 'a') as f:
        ...
        for i in range(0, 10000):
            for j in range(99):
                ...
                f.write(intstr(i) + '\n')
        f.write('zece mii' + '\n')
    print('''Verifică pe desktop fișierul textual "output" (52.9 MB).
    Te sfătuiesc să îl deschizi în Visual Studio.''')
